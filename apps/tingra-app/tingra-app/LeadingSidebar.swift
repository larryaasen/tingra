...
struct LeadingSidebar: View {
    ...
    ///
    /// The heading carries no casting picker (removed 2026-09-13;
    /// ARCHITECTURE.md, "The casting pickers are removed"): which device a
    /// layer shows is the inspector's Input popup, and what to stage is a row
    /// click — a third control over the same decision only disagreed with them.
